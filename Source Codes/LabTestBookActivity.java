...
Button book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cont=findViewById(R.id.mobile);
        pin=findViewById(R.id.pincode);
        book=findViewById(R.id.bookmedicine);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.addOrder(username,name.getText().toString(),addr.getText().toString(),cont.getText().toString(),Integer.parseInt(pin.getText().toString()),date.toString(),time.toString(),Float.parseFloat(price[1].toString()),"lab");
